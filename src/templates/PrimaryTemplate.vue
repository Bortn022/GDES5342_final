  ...
  <footer>
    <a href="mailto:carabortnem@gmail.com">
      <svg class="email" width="3.5rem" height="3.5rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4 7.00005L10.2 11.65C11.2667 12.45 12.7333 12.45 13.8 11.65L20 7" stroke="#cabead" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        <rect x="3" y="5" width="18" height="14" rx="2" stroke="#cabead" stroke-width="2" stroke-linecap="round"/>
      </svg>
    </a>
    <a href="https://www.instagram.com/carabortnem/">
      <svg class="icon" fill="#cabead" width="3rem" height="3rem" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
    ...
    <a href="https://www.linkedin.com/in/cara-bortnem-692246249/">
      <svg class="icon" fill="#cabead" height="2.4rem" width="2.4rem" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
